...
jQuery(document).ready(function(n) {
    n(".sp-wcsp-slider-area").each(function(e) {
        var i = n(this),
            a = n(this).attr("id"),
            t, o;
        i.data("slider") && !n("#" + a + " .sp-wcsp-slider-section").hasClass("swiper-container-initialized") && (t = i.data("slider"), o = new Swiper("#" + a + " .swiper-container", {
            loop: t.infinite_loop,
            speed: t.standard_scroll_speed,
            autoplay: t.auto_play ? {
                delay: t.auto_play_speed,
            ...
            navigation: ("show" == t.navigation || "hide_mobile" == t.navigation) && {
                nextEl: "#" + a + " .sp-wcsp-button-next",
                prevEl: "#" + a + " .sp-wcsp-button-prev"
            },
            pagination: "show" == t.pagination ? {
            ...
            breakpoints: {
                480: {
                    ...
                    pagination: "show" == t.pagination || "hide_mobile" == t.pagination ? {
                        el: ".sp-wcsp-pagination",
                        type: "bullets",
                        clickable: !0
                    } : {}
        ...
        }), 1 == t.pause_on_hover && 1 == t.auto_play && n("#" + a + " .swiper-container").hover(function() {
            o.autoplay.stop()
        }, function() {
            o.autoplay.start()
