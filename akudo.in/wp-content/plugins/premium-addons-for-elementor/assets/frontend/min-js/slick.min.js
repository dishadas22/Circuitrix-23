! function(i) {
    ...
    (s = 0, r = function(i, e) {
        ...
        var i, e = this,
            ...
            o = 0,
            s = [];
        for (i = !1 === e.options.infinite ? e.slideCount : (t = e.options.slidesToScroll * -Math.ceil(e.slideCount / 2), o = e.options.slidesToScroll * -Math.ceil(e.slideCount / 2), 2 * e.slideCount); t < i;) s.push(t), t = o + e.options.slidesToScroll, o += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
        return s
